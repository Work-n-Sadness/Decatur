...
export const mockInstallations: FacilityInstallation[] = [
  ...
  { id: 'inst8', installationName: 'Kitchen Gas Range', category: 'Gas Systems', location: 'Kitchen', lastInspectionDate: new Date(2024, 9, 15), nextInspectionDue: new Date(2025, 9, 15), inspectionFrequency: 'Annually', serviceVendor: 'GasSafe Co.', status: 'Operational', notes: 'Pilot lights checked.', createdAt: subMonths(now, 7), updatedAt: subMonths(now, 4)},
  { id: 'inst9', installationName: 'Air Purifier Unit - Common Area', category: 'Air Quality', location: 'Main Common Area', lastInspectionDate: new Date(2025, 4, 10), nextInspectionDue: addMonths(new Date(2025, 4, 10), 3), inspectionFrequency: 'Quarterly', serviceVendor: 'In-house Maintenance', status: 'Operational', notes: 'Filter cleaned.', createdAt: subMonths(now, 0), updatedAt: subMonths(now, 0)},
  { id: 'inst10', installationName: 'Wheelchair Ramp - Main Entrance', category: 'Accessibility', location: 'Main Entrance', lastInspectionDate: new Date(2025, 2, 1), nextInspectionDue: new Date(2026, 2, 1), inspectionFrequency: 'Annually', serviceVendor: 'Facility Maintenance Team', status: 'Operational', notes: 'No cracks or obstructions.', createdAt: subMonths(now, 2), updatedAt: subMonths(now, 1)},
].map(install => ({
    ...install,
